...
#define EVENT_PURCHASE_CANCELED (uint8_t*)[@"EVENT_PURCHASE_CANCELED" UTF8String]
...
#define EVENT_CONSUME_SUCCESS (uint8_t*) [@"EVENT_CONSUME_SUCCESS" UTF8String]
#define EVENT_CONSUME_FAILURE (uint8_t*) [@"EVENT_CONSUME_FAILURE" UTF8String]
